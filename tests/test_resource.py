...
class ResourceTestCase(TestCase):
    ...
    def test_resource_source_add(self):
        resources = resource.ResourceManager()
        resources.add_income_source("Sol", "Earth", 50, 50, 100)
        ...
        self.assertEqual(resources.income_sources, {"Sol": {"Earth": [50, 50 , 100]}})
        resources.add_income_source("Sol", "Moon", 5, 5, 10)
        ...
        self.assertEqual(resources.income_sources, {"Sol": {"Earth": [50, 50 , 100], "Moon": [5, 5, 10]}})
    ...
    def test_invalid_source_add(self):
        ...
        with self.assertRaises(resource.Location_Already_Exists) as context:
            resources.add_income_source("Sol", "Earth", 100, 100, 100)
    ...
    def test_update_source_income(self):
        resources = resource.ResourceManager()
        resources.add_income_source("Sol1", "P1", 50, 50, 100)
